    ...
    <div class="card shadow-lg bg-primary text-white mb-4">
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="mb-1">
                        <i class="fa-solid fa-plus-circle me-2"></i>Create New Blog Post
                    </h4>
                    <p class="text-white mb-0">Add a new blog post with rich content and SEO optimization</p>
                </div>
                <div class="col-md-4 text-end">
                    <a href="{{ route('admin.posts') }}" class="btn btn-outline-light btn-sm">
                        <i class="fa-solid fa-arrow-left me-2"></i>Back to Posts
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary">
                    <h5 class="mb-0 text-white">
                        <i class="fa-solid fa-edit me-2"></i>Post Content
                    </h5>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="store" method="POST">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">
                                <i class="fa-solid fa-heading me-2 text-muted"></i>Post Title
                            </label>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">
                                <i class="fa-solid fa-info-circle me-1"></i>This will be your post URL: {{ url('/') }}/blog/<span class="fw-bold">{{ $slug ?: 'your-slug' }}</span>
                            </small>
                            @error("slug") 
                                <div class="text-danger mt-2">
                                    <i class="fa-solid fa-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea wire:model.live.debounce.150ms="meta_description" 
                                          rows="3" 
                                          class="form-control" 
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">
                                <i class="fa-solid fa-file-alt me-2 text-muted"></i>Post Content
                            </label>
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fa-solid fa-save me-2"></i>Create Post
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-lg mb-4">
                <div class="card-header bg-warning">
                    <h6 class="mb-0 text-white">
                        <i class="fa-solid fa-toggle-on me-2"></i>Post Status
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" wire:model="status" id="create-post-status-draft" value="draft">
                                <label class="form-check-label" for="create-post-status-draft">Draft</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" wire:model="status" id="create-post-status-published" value="published">
                                <label class="form-check-label" for="create-post-status-published">Published</label>
                            </div>
                        </div>
                        @error('status')
                            <div class="text-danger mt-2">
            ...
            <div class="card shadow-lg mb-4">
                <div class="card-header bg-info">
                    <h6 class="mb-0 text-white">
                        <i class="fa-solid fa-image me-2"></i>Post Banner
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    @if ($post_file)
                        <div class="border rounded p-3 bg-light">
                            ...
                            <img src="{{ $post_file->temporaryUrl() }}" 
            ...
            <div class="card shadow-lg mb-4">
                <div class="card-header bg-warning">
                    <h6 class="mb-0 text-white">
                        <i class="fa-solid fa-tags me-2"></i>Select Categories
                    </h6>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-3">Choose one or more categories for this post:</p>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="container-options">
                            ...
                            <div class="container-option mb-3">
                                <input type="radio" wire:model="container_type" value="container" id="create-post-container-standard" class="btn-check">
                                <label for="create-post-container-standard" class="btn btn-outline-primary w-100 text-start">
                                    <div class="d-flex align-items-center">
                            ...
                            <!-- Narrow Container -->
                            <div class="container-option mb-3">
                                <input type="radio" wire:model="container_type" value="narrow" id="create-post-container-narrow" class="btn-check">
                                <label for="create-post-container-narrow" class="btn btn-outline-primary w-100 text-start">
                                    <div class="d-flex align-items-center">
                                        <div class="container-visual me-3">
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-info">
                    <h6 class="mb-0 text-white">
                        <i class="fa-solid fa-info-circle me-2"></i>Post Information
                    </h6>
                </div>
                <div class="card-body">
