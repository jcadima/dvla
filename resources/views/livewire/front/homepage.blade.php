<div>
    ...
    <section class="dvla-hero">
        <div class="container text-center">
            ...
            <h1 class="dvla-hero-title">Damn Vulnerable Laravel Application</h1>
            ...
            <div class="dvla-hero-ctas">
                <a href="{{ route('login') }}" class="btn dvla-btn-primary">
                    <i class="fa-solid fa-terminal me-2"></i>Go to Dashboard
                </a>
                <a href="https://github.com/jcadima/dvla" target="_blank" class="btn dvla-btn-ghost">
            ...
            <div class="row g-4 mt-2">
                ...
                <div class="col-md-4">
                    <div class="dvla-why-card h-100">
                        ...
                        <p>Vulnerabilities chain into a complete host compromise: <code>.env</code> leak -> APP_KEY RCE -> <code>docker.sock</code> escape.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="dvla-why-card h-100">
                        ...
                        <h5>Blog-Guided</h5>
                        <p>Every exploit module has a companion post on jcadima.dev with source code walkthroughs, proof-of-concept steps, and side-by-side remediation.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="dvla-section dvla-killchain">
        <div class="container">
            ...
            <p class="dvla-section-sub text-center">Four individually defensible shortcuts that compound into a full host compromise.</p>
            <div class="dvla-chain">
                ...
                <div class="dvla-chain-step">
                    ...
                    <div>
                        ...
                        <small>Forged session cookie -> deserialization RCE</small>
                    </div>
                </div>
                <div class="dvla-chain-arrow"><i class="fa-solid fa-arrow-right"></i></div>
                <div class="dvla-chain-step">
    ...
    <section class="dvla-section dvla-modules">
        <div class="container">
            ...
            <p class="dvla-section-sub text-center">Explore each module independently in the dashboard. Each one maps to a blog post with a full exploit walkthrough.</p>
    ...
    <section class="dvla-section dvla-blog">
        <div class="container">
            ...
            <p class="dvla-section-sub text-center">
                Full write-ups published at <strong><a class="fw-bold text-white" target="_blank" href="https://jcadima.dev/blog">jcadima.dev/blog</a></strong> as the series rolls out.
                Each post includes source code review, step-by-step exploit, and remediation.
            </p>
            <div class="row g-3 mt-2">
                @php
                $posts = [
                    ['num' => 1, 'title' => 'Mass assignment in Eloquent: the vulnerability hiding in plain sight'],
                    ['num' => 2, 'title' => 'Nginx misconfiguration to RCE: the .env leak and the APP_KEY deserialization chain'],
                    ['num' => 3, 'title' => 'Type juggling in PHP: bypassing authentication with == vs ==='],
                    ['num' => 4, 'title' => 'IDOR on Laravel API routes: when route model binding is not enough'],
                    ['num' => 5, 'title' => 'Livewire file upload bypass: MIME trust and the path to RCE'],
                    ['num' => 6, 'title' => 'Stored XSS via the admin panel: when {!! !!} trusts unsanitized input'],
                    ['num' => 7, 'title' => 'Redis with no authentication:how your queue worker becomes a backdoor'],
                    ['num' => 8, 'title' => 'Docker misconfigurations: turning container RCE into host compromise'],
                    ['num' => 9, 'title' => 'Chaining all of it: a full kill chain against a Laravel application'],
                ];
                @endphp
                @foreach($posts as $post)
                <div class="col-md-6 col-lg-4">
                    <div class="dvla-blog-card">
                        <span class="dvla-blog-num">{{ $post['num'] }}</span>
                        <div class="dvla-blog-body">
                            <p>{{ $post['title'] }}</p>
                        </div>
                    </div>
                </div>
